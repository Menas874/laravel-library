...
@section('title', 'Editar recurso literario')
...
@section('header', 'Editar recurso literario | ' . $resource->title)
      ...
      <div class="col-lg-12">
          <div class="panel panel-default">
              <div class="panel-body">
                  <div class="row">
                      <div class="col-lg-12">
                        {!! Form::open(['route' => ['admin.resources.update', $resource->id], 'method' => 'PUT', 'class' =>'form-horizontal']) !!}
                        <div class="form-group">
                            {!! Form::label('title', 'Título', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::text('title', $resource->title, ['class' => 'form-control', 'placeholder' => 'Titulo del recurso literario', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('author', 'Autor', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::text('author', $resource->author, ['class' => 'form-control', 'placeholder' => 'Autor del recurso', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('editorial', 'Editorial', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::text('editorial', $resource->editorial, ['class' => 'form-control', 'placeholder' => 'Editorial del recurso', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('category_id', 'Categoría', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::select('category_id', $categories, $resource->category->id, ['class' => 'form-control select-category', 'placeholder'=>'Seleccione una categoría', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('content', 'Descripción', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::textarea('content', $resource->content, ['class' => 'form-control textarea-content', 'placeholder' => 'Descripción', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                {!! Form::select('tags[]', $tags, $ay_tags, ['class' => 'form-control select-tag', 'multiple', 'required']) !!}
                            </div>
                        </div>
